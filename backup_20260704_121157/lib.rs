...
const PLACE_ORDER_URL:  &str = "https://github.com/anoadder-ship-it/darkpool-circuits/releases/download/v0.11.2/place_order.arcis";
const MATCH_ORDERS_URL: &str = "https://github.com/anoadder-ship-it/darkpool-circuits/releases/download/v0.11.2/match_orders.arcis";
const CANCEL_ORDER_URL: &str = "https://github.com/anoadder-ship-it/darkpool-circuits/releases/download/v0.11.2/cancel_order.arcis";
const GET_STATS_URL:    &str = "https://github.com/anoadder-ship-it/darkpool-circuits/releases/download/v0.11.2/get_stats.arcis";
...
pub mod solana_darkpool {
    ...
    pub fn place_order(
        ...
        let args = ArgBuilder::new()
            ...
            .plaintext_u128(nonce1)
            .encrypted_u64(encrypted_bid)
            .x25519_pubkey(pubkey)
            .plaintext_u128(nonce2)
            .encrypted_u64(encrypted_size)
            .x25519_pubkey(pubkey)
            .plaintext_u128(nonce3)
