...
async function main() {
  ...
  console.log('Escrow PDA (Medical, voor dispute-test):', escrowPda.toString());

  console.log('\n=== TEST: create_escrow (Medical, voor dispute-scenario) ===');
  ...
  const isDisputed = 'disputed' in escrowState.status;
  console.log(isDisputed ? '\nTEST GESLAAGD: status correct op Disputed.' : '\nTEST GEFAALD.');

  console.log('\nEscrow PDA voor resolve_dispute-test:');
