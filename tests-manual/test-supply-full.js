...
async function main() {
  ...
  const idl = JSON.parse(fs.readFileSync('/home/michel/solana_darkpool/target/idl/supply_chain_darkpool.json', 'utf8'));
  ...
  // --- TEST B: create_escrow -> dispute_escrow (voorbereiding voor resolve_dispute) ---
  await new Promise(r => setTimeout(r, 1500)); // korte pauze zodat seed_id (timestamp) echt anders is
